  ...
  <div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-white">
      ...
      <a class="navbar-brand order-1" href="index.html">
        ...
        <img class="img-fluid" width="100px" src="{{ asset('assets/admin/img/haha.png') }}" 
      ...
      <div class="collapse navbar-collapse text-center order-lg-2 order-3" id="navigation">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item dropdown">
            ...
            {{-- <a href="{{ url('client') }}" aria-expanded="false">
              <div class="icon_menu">
                  <img src="{{ asset('assets/client/img/menu-icon/dashboard.svg') }}" alt>
              </div>
              <span>homepage</span>
          </a> --}}
            <div class="dropdown-menu">
              <a class="dropdown-item" href="{{ url('client/index-full.html') }}">Homepage Full Width</a>
